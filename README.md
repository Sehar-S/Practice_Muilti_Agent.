...
This notebook is a hands-on practice project where I explored how multiple AI agents can work together, communicate, and perform tasks collaboratively using Python.
 ...
 Hands-on Python practice with AI agents
 Beginner-friendly practice notebook

It’s not a complete project  just a practice notebook to learn and experiment with multi-agent concepts. 
